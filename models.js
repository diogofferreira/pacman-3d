...
function recSubdivisionCentroid( v1, v2, v3, 
	...
	if( recursionDepth == 0 ) {
		...
		// Compute the centroids and proceed recursively
        ...
        recSubdivisionCentroid( v1, v2, centroid, c1, c2, colorCentroid,
                                coordsArray, colorsArray, recursionDepth - 1 );
        recSubdivisionCentroid( v2, v3, centroid, c2, c3, colorCentroid,
                                coordsArray, colorsArray, recursionDepth - 1 );
        recSubdivisionCentroid( v3, v1, centroid, c3, c1, colorCentroid,
                                coordsArray, colorsArray, recursionDepth - 1 );
	}
...
function moveToSphericalSurface( coordsArray ) {
	...
	for (i = 0; i < origArrayLength; i += 3) {
		var v = origCoords.slice(i, i + 3);
